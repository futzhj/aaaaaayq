...
typedef struct {
    ...
    Uint32 mode;
    Uint8 fsb_ver;
    FSOUND_FSB_SAMPLE_HEADER_3_1* info;
    Uint32* list;

    struct FSB5_Sample* samples5;
    char* names5;
    Uint32 data_offset_base;
    Uint32 data_size;

} FSB_UserData;
int FSB_Create(lua_State* L, Uint8* data, size_t size);

typedef struct FSB5_Sample {
    Uint32 dataOffset;
    Uint32 dataSize;
    Uint32 frequency;
    Uint32 samples;
