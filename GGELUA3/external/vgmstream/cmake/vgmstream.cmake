...
macro(setup_target TARGET)
	...
	if(USE_MPEG)
		...
		if(WIN32)
			...
			if(LINK)
				if(MPG123_LIBRARIES)
					target_link_libraries(${TARGET} PUBLIC ${MPG123_LIBRARIES})
				else()
					target_link_libraries(${TARGET} PUBLIC mpg123)
				endif()
			endif()
		endif()
	endif()
	...
	if(USE_VORBIS)
		...
		if(WIN32)
			...
			if(LINK)
				if(ANDROID)
					target_link_libraries(${TARGET} PUBLIC vorbisfile vorbis ogg)
				elseif(TARGET Vorbis::VorbisFile)
					target_link_libraries(${TARGET} PUBLIC Vorbis::VorbisFile)
				elseif(VORBISFILE_LIBRARIES)
					target_link_libraries(${TARGET} PUBLIC ${VORBISFILE_LIBRARIES})
				else()
					target_link_libraries(${TARGET} PUBLIC vorbisfile vorbis ogg)
				endif()
			endif()
